      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-44 pb-12 md:pt-56 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-rose-900 leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">I <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-pink-600">love</span> web.</h1>
            <h1 className="text-4xl md:text-5xl font-extrabold text-rose-500 leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Valentine's Day is about <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-pink-600">love.</span></h1>
